...
vupdate()
{
  ...
  while true; do
    ...
    echo -e "${InvGreen} ${CClear} Current Version: ${CGreen}$version${CClear}"
    echo -e "${InvGreen} ${CClear} Updated Version: ${CGreen}$DLversion${CClear}"
    echo -e "${InvGreen} ${CClear}"
    echo -e "${InvGreen} ${CClear}${CDkGray}---------------------------------------------------------------------------------------${CClear}"
    echo -e "${InvGreen} ${CClear}"
    echo -e "${InvGreen} ${CClear}${CWhite} Beta Track"
    echo -e "${InvGreen} ${CClear} Current Version: ${CGreen}$version${CClear}"
    echo -e "${InvGreen} ${CClear} Updated Version: ${CGreen}$Bversion${CClear}"
    echo -e "${InvGreen} ${CClear}"
    echo -e "${InvGreen} ${CClear}${CDkGray}---------------------------------------------------------------------------------------${CClear}"
    echo -e "${InvGreen} ${CClear}"
